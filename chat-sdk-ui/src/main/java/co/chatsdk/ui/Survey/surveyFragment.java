...
public class surveyFragment extends BaseFragment {
    ...
    public static surveyFragment newInstance(int loadingMode, int clickMode, Object extraData) {
        surveyFragment f = new surveyFragment();
     ...
     */
    public static surveyFragment newThreadUsersDialogInstance(String threadID, String title) {
        surveyFragment f = new surveyFragment();
        f.setTitle(title);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mainView = inflater.inflate(R.layout.chat_sdk_survey, null);
