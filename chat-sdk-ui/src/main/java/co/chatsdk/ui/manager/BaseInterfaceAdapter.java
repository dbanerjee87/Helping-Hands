...
//        FLog.setMinimumLoggingLevel(FLog.VERBOSE);
    ...
    public Tab resourcesTab() {
        return new Tab("Resources", R.drawable.ic_search, resourcesFragment.newInstance());
    }

    @Override
    public Tab surveyTab() {
        return new Tab("Baseline Survey", R.drawable.ic_search, surveyFragment.newInstance());
    }
