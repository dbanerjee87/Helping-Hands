...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected Button btnLogin, btnReg;
...
//                            Toast.makeText(LoginActivity.this, throwable.getLocalizedMessage(), Toast.LENGTH_LONG).show();
    ...
    protected boolean checkFields(){
        ...
        if (!(usernameEditText.getText().toString()).contains("gatech.edu")){
            showToast("Please Enter Gatech Email");
            return false;
        }
        ...
        //ADD IS PROFESSIONAL CHECK HERE
        if ((usernameEditText.getText().toString()).contains("health")) {
            isProfessional = 1;
